      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 rounded-xl" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
          ...
          <p className="text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
            Non-Exclusive Commercial Rights granted. Unlimited audio streaming, up to 500,000 video views, and radio broadcasting rights included.
          </p>
        </div>

        <div className="p-6 rounded-xl" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
          <h3 className="text-sm font-semibold mb-3 flex items-center gap-2">
            <Clock size={16} style={{ color: "var(--accent-cyan)" }} /> Unlimited Re-downloads
          </h3>
          <p className="text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
            Your download links are stored securely in your BeatVault account. Access your purchased files anytime from your Dashboard.
          </p>
        </div>
      </div>
    </div>
